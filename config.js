// config.js
// استخدم الخادم المحلي أثناء التطوير، وخادم اللوحة المنشور في Render عند زيارة الموقع المستضاف.
window.SERVER_HUB_URL = window.location.origin.includes('localhost') || window.location.origin.includes('127.0.0.1')
  ? "http://localhost:5000"
  : "https://panel-back.onrender.com";
...
(function() {
    ...
    function sendPing() {
        ...
        .catch(function(error) {
            console.error('[Tracker] Ping failed:', error);
        });
    }
    ...
    fetch(SERVER_HUB_URL + '/api/sites/auto-register', {
        ...
        console.error('[Tracker] Site registration failed:', error);
    });
